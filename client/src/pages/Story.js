    ...
    <Layout>
      <section className="padding-x-large padding-y-large story flex show-on-scroll">
        ...
        <div className="story-text">
          <p>
            My name is Joanna. I’m a front end developer. I come from Poland and
            I'm currently residing in <strong>Aalborg, DK.</strong>
          </p>
          <p>
            I’m studying <strong>Multimedia Design</strong> at UCN, with the
            goal to finish with a Bachelor’s degree in Web Development.
          </p>
          <p>
          ...
          <h5 className="padding-y-extra-small gradient-underline-hover portfolio-link">
            <a href="https://noxaunu.artstation.com/">
              Digital art portfolio <i className="fas fa-external-link-alt"></i>
            </a>
          </h5>
        </div>
      </section>
