    ...
    <Layout>
      <section className="padding-x-large padding-y-small flex values show-on-scroll">
        ...
        <div className="values-text">
          <p>
            The act of creation is my greatest passion, and I make sure that it
            shows in my efforts.
          </p>
          <p>
      ...
      <section className="padding-x-large padding-y-small flex values show-on-scroll">
        <div className="values-text">
          <p>
            With each new project I take up new technologies, tools and methods.
            I like to be ahead of the game and keep up to date with trends and
            tools.
          </p>
          <p>
      ...
      <section className="padding-x-large padding-y-small flex values show-on-scroll">
        ...
        <div className="values-text">
          <p>
            I always consider who the creation is aimed at, and how it can best
            serve it's purpose.
          </p>
          <p>
      ...
      <section className="padding-x-large padding-y-small flex values show-on-scroll">
        <div className="values-text">
          <p>
            Half-measures and doing the minimum won't do for me. If I take up a
            task, I will do it well.
          </p>
          <p>
            I consider all aspects of a project and make sure that none of them
            will fall short as a result of my decisions.
          </p>
        </div>
        <div className="values-icons">
          <h1>Excellence</h1>
      ...
      <section className="padding-x-large padding-y-small flex values show-on-scroll">
        ...
        <div className="values-text">
          <p>
            I set precise tasks and goals and aim to achieve them. I always look
